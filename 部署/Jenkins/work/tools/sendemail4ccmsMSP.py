...
if __name__ == "__main__":
    ...
    try:
        ...
        nameList = ["clarkmeng@cmbchina.com", "xxamo@cmbchina.com", ]
        ccList = "lenghj@cmbchina.com"
        emailList = ", ".join(nameList)
        returnCode = client.service.SendCMBEmail(emailList, ccList, "", subject.decode('gb2312'), content.decode('gb2312'))
        if (returnCode == None) :
