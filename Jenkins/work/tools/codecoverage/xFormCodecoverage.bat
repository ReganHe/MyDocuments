...
SET PROJPATH=D:\work\hff_workspace\xForm\Code\Project\xForm\xForm.UnitTest\bin
...
dotCover.exe analyse /TargetExecutable="%MSTESTBIN%\MSTest.exe" /TargetArguments="/testcontainer:%PROJPATH%\Release\xForm.UnitTest.dll" ^
