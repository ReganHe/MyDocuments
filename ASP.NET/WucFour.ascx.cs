...
public partial class WucFour : System.Web.UI.UserControl
{
    ...
    {
        _data = CategoryService.GetCategories();
        var categories = _data.Select(r => new Category { Id = r.Id, Name = r.Name });
    ...
    protected void ddlTempCategory1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddl != null)
        {
            ...
            var categories = _data.FirstOrDefault(r => r.Id == cate1)
                .SubCategories
                .Select(r => new Category { Id = r.Id, Name = r.Name });
    ...
    protected void ddlTempCategory2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddl != null)
        {
            ...
            var categories = _data.FirstOrDefault(r => r.Id == cate1)
                .SubCategories.FirstOrDefault(r => r.Id == cate2)
                .SubCategories
                .Select(r => new Category { Id = r.Id, Name = r.Name });
    ...
    protected void ddlTempCategory3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddl != null)
        {
            ...
            var categories = _data.FirstOrDefault(r => r.Id == cate1)
                .SubCategories.FirstOrDefault(r => r.Id == cate2)
                .SubCategories.FirstOrDefault(r => r.Id == cate3)
                .SubCategories
                .Select(r => new Category { Id = r.Id, Name = r.Name });
